...
export default function Dashboard() {
  ...
  const currentView =
    new URLSearchParams(searchParams).get("view") || "dashboard";
        ...
        <div className="mb-6 flex gap-3">
          ...
          >
            <div
              className={`p-1.5 rounded ${
                !showUserManagement ? "bg-blue-100" : "bg-blue-100"
              }`}
            >
          ...
          {permissions.canManageUsers && (
            ...
            >
              <div
                className={`p-1.5 rounded ${
                  showUserManagement ? "bg-green-100" : "bg-green-100"
                }`}
              >
          ...
          {permissions.canManageUsers && (
            ...
            >
              <div
                className={`p-1.5 rounded ${
                  showPlantillasWordAdmin ? "bg-purple-100" : "bg-purple-100"
                }`}
              >
              ...
              <Card>
                ...
                <CardContent>
                  <div className="space-y-4">
                    {(stats?.solicitudesPorOperador || []).map(
                      (item: any, index: number) => {
                        ...
                        const percentage =
                          (stats?.totalSolicitudes || 0) > 0
                            ? (item.total / (stats?.totalSolicitudes || 1)) *
                              100
                            : 0;
                    ...
                    {(stats?.actividadReciente || []).length === 0 ? (
                      ...
                      (stats?.actividadReciente || []).map(
                        (activity: any, index: number) => {
                          ...
                          const iconInfo =
                            icons[activity.estado as keyof typeof icons] ||
                            icons.procesando;
                          ...
                          return (
                            ...
                            >
                              <div
                                className={`${iconInfo.color} p-2 rounded-full`}
                              >
                                <Icon className="h-4 w-4" />
                              </div>
                              <div className="flex-1">
                                <p className="text-sm font-medium text-gray-800">
                                  Solicitud #{activity.numeroSolicitud} -{" "}
                                  {activity.estado}
                                </p>
                                <p className="text-xs text-gray-500">
